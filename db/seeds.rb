...
Visit.create  country: 'South Korea', visited_at: DateTime.now - 3.days, load_time: 5.0
Visit.create  country: 'Japan', visited_at: DateTime.now, load_time: 2.0
Visit.create  country: 'Japan', visited_at: DateTime.now, load_time: 2.5
Visit.create  country: 'Japan', visited_at: DateTime.now, load_time: 1.0
Visit.create  country: 'Japan', visited_at: DateTime.now, load_time: 1.5
Visit.create  country: 'Japan', visited_at: DateTime.now - 1.day, load_time: 2.5
Visit.create  country: 'Japan', visited_at: DateTime.now - 1.day, load_time: 4.0
Visit.create  country: 'Japan', visited_at: DateTime.now - 1.day, load_time: 3.0
Visit.create  country: 'Japan', visited_at: DateTime.now - 2.days, load_time: 1.0
Visit.create  country: 'Japan', visited_at: DateTime.now - 3.days, load_time: 5.0
Visit.create  country: 'Japan', visited_at: DateTime.now - 3.days, load_time: 4.0
Visit.create  country: 'Japan', visited_at: DateTime.now - 3.days, load_time: 5.0